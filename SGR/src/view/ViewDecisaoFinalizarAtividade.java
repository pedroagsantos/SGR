...
public class ViewDecisaoFinalizarAtividade {
	 ...
	 */
	public ViewDecisaoFinalizarAtividade(Atividade atividade) {
	...
	private void initialize() {
		...
		JButton btnCancelarAtividade = new JButton("Finalizar Atividade");
		
		btnCancelarAtividade.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				
				controleAtividade.finalizarAtividade(atividade);
